...
import (
	...
	"github.com/goscorum/scorumgo/internal/rpc"
...
func (api *API) GetFollowersRaw(
	...
	if err := api.call("get_followers", params, &resp); err != nil {
		return nil, errors.Wrap(err, "goscorum/scorumgo: follow_api: failed to call get_followers")
	}
	return &resp, nil
}
...
func (api *API) GetFollowers(
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrap(
			err, "goscorum/scorumgo: follow_api: failed to unmarshal get_followers response")
	}
	return resp, nil
...
func (api *API) GetFollowingRaw(
	...
	if err := api.call("get_following", params, &resp); err != nil {
		return nil, errors.Wrap(err, "goscorum/scorumgo: follow_api: failed to call get_following")
	}
	return &resp, nil
}
...
func (api *API) GetFollowing(
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrap(
			err, "goscorum/scorumgo: follow_api: failed to unmarshal get_following response")
	}
	return resp, nil
}
...
func (api *API) GetFeedEntriesRaw(
	...
	if err := api.call("get_feed_entries", params, &resp); err != nil {
		return nil, errors.Wrap(err, "goscorum/scorumgo: follow_api: failed to call get_feed_entries")
	}
	return &resp, nil
}
...
func (api *API) GetFeedEntries(
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrap(
			err, "goscorum/scorumgo: follow_api: failed to unmarshal get_feed_entries response")
	}
	return resp, nil
}
...
func (api *API) GetFeedRaw(
	...
	if err := api.call("get_feed", params, &resp); err != nil {
		return nil, errors.Wrap(err, "goscorum/scorumgo: follow_api: failed to call get_feed")
	}
	return &resp, nil
}
...
func (api *API) GetAccountReputationsRaw(
	...
	if err := api.call("get_account_reputations", params, &resp); err != nil {
		return nil, errors.Wrap(
			err, "goscorum/scorumgo: follow_api: failed to call get_account_reputations")
	}
	return &resp, nil
}

func (api *API) GetFollowCountRaw(
	accountName string,
) (*json.RawMessage, error) {

	var resp json.RawMessage
	params := []interface{}{accountName}
	if err := api.call("get_follow_count", params, &resp); err != nil {
		return nil, errors.Wrap(err, "goscorum/scorumgo: follow_api: failed to call get_follow_count")
	}
	return &resp, nil
}

func (api *API) GetFollowCount(
	accountName string,
) (*FollowCount, error) {
	...
	if err := json.Unmarshal([]byte(*raw), &resp); err != nil {
		return nil, errors.Wrap(
			err, "goscorum/scorumgo: follow_api: failed to unmarshal get_follow_count response")
	}
	return resp, nil
}
